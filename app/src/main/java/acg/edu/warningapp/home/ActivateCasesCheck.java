...
public class ActivateCasesCheck extends AppCompatActivity {

    String country, messageCase, time, radius, phoneNo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activate_cases_check);
        ...
        //Read from session values (Preferences class)
...
//                        textView.setText(stringBuilder);
        ...
        if (!time.equals("Manual")) {
            //create alarm
            AlarmCheck alarmHandler = new AlarmCheck(this);
            //set alarm
                                    ...
                                    for (DataSnapshot item : dataSnapshot.getChildren()) {
                                        ...
                                        if (dataSnapshot.exists()) {
                                            ...
                                            if (distance < f_radius) {
                                                ...
                                                //Remove the ones that the user has already been alerted (Exist in the user's account database)
                                                displayList.removeAll(id_all);
                                                id_list.removeAll(id_match_list);
...
//
                                                ...
                                                NotificationCompat.Builder builder = new NotificationCompat.Builder(ActivateCasesCheck.this, CHANNEL_1_ID)
                                                ...
                                                Intent intent = new Intent(ActivateCasesCheck.this, CasesNearAlert.class);
...
//
                                                ...
                                                //Send Notification
                                                PendingIntent pendingIntent = PendingIntent.getActivity(ActivateCasesCheck.this, 0, intent, PendingIntent.FLAG_UPDATE_CURRENT);
                        ...
                        //Send a new location request
                            ...
                            if (ActivityCompat.checkSelfPermission(ActivateCasesCheck.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(ActivateCasesCheck.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                                // TODO: Consider calling
                                //    ActivityCompat#requestPermissions
                                // here to request the missing permissions, and then overriding
                                //   public void onRequestPermissionsResult(int requestCode, String[] permissions,
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                //Check locations services if allowed
                LocationManager locationManager = (LocationManager) getSystemService(Context.LOCATION_SERVICE);
                if (locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER)
                        || locationManager.isProviderEnabled(LocationManager.NETWORK_PROVIDER)) {
                    if (ActivityCompat.checkSelfPermission(ActivateCasesCheck.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(ActivateCasesCheck.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
...
//-----------------------------------------SEND-TO-HOMEPAGE-----------------------------------------------------
        //Run the homepage after the delay timer
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {

                Intent launchSecondIntent = new Intent(getBaseContext(), HomePage.class);
